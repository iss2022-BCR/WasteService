...
package it.unibo.alarmcontroller
...
class Alarmcontroller ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
		...
		return { //this:ActionBasciFsm
				...
				state("state_idle") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t00",targetState="state_handle_sonar_data",cond=whenDispatch("sonar_data"))
				}	 
