...
package it.unibo.alarmcontroller_ls_test
...
class Alarmcontroller_ls_test ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
		...
		return { //this:ActionBasciFsm
				...
				state("state_idle") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t017",targetState="state_handle_sonar_data",cond=whenDispatch("sonar_data"))
				}	 
