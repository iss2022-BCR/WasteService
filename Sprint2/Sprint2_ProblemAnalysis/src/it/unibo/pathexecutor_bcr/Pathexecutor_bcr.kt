		...
		return { //this:ActionBasciFsm
				state("init") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t012",targetState="doThePath",cond=whenRequest("dopath"))
				}	 
					...
					sysaction { //it:State
				 	 		//sysaction { //it:State
				 	 		  stateTimer = TimerActor("timer_doMoveTurn", 
				 	 			scope, context!!, "local_tout_pathexecutor_bcr_doMoveTurn", 350.toLong() )
				 	 		//}
					}	 	 
					 transition(edgeName="t113",targetState="nextMove",cond=whenTimeout("local_tout_pathexecutor_bcr_doMoveTurn"))   
				}	 
