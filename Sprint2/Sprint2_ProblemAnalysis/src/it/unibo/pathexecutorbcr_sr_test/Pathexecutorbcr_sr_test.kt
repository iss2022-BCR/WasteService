...
package it.unibo.pathexecutorbcr_sr_test
...
class Pathexecutorbcr_sr_test ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
		...
		return { //this:ActionBasciFsm
					...
					sysaction { //it:State
				 	 		//sysaction { //it:State
				 	 		  stateTimer = TimerActor("timer_state_do_move_turn", 
				 	 			scope, context!!, "local_tout_pathexecutorbcr_sr_test_state_do_move_turn", 350.toLong() )
				 	 		//}
					}	 	 
					 transition(edgeName="t212",targetState="state_next_move",cond=whenTimeout("local_tout_pathexecutorbcr_sr_test_state_do_move_turn"))   
				...
				state("state_end_work_ok") { //this:State
					action { //it:State
						...
						answer("dopath", "dopathdone", "dopathdone(ok)","transporttrolley_sr_test"   )  
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
					sysaction { //it:State
				...
				state("state_end_work_fail") { //this:State
					action { //it:State
						...
						answer("dopath", "dopathfail", "dopathfail($PathStillTodo)","transporttrolley_sr_test"   )  
