...
with Diagram('wasteservice_rpiArch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
     ...
     with Cluster('ctx_wasteservice', graph_attr=nodeattr):
          ...
          status_controller=Custom('status_controller(ext)','./qakicons/externalQActor.png')
