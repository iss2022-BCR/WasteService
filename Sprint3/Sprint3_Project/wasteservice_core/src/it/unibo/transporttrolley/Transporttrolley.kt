		...
		return { //this:ActionBasciFsm
				...
				state("state_idle") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t09",targetState="state_handle_deposit_request",cond=whenRequest("deposit"))
				}	 
				...
				state("state_move_to_indoor") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t110",targetState="state_pickup",cond=whenReply("dopathdone"))
				...
				state("state_move_to_box") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t212",targetState="state_dump",cond=whenReply("dopathdone"))
					transition(edgeName="t213",targetState="state_error",cond=whenReply("dopathfail"))
				}	 
				...
				state("state_move_to_home") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t314",targetState="state_idle",cond=whenReply("dopathdone"))
					transition(edgeName="t315",targetState="state_error",cond=whenReply("dopathfail"))
				}	 
