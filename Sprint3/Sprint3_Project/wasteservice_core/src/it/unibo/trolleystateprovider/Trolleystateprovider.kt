		...
		return { //this:ActionBasciFsm
				...
				state("state_idle") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t016",targetState="state_update_trolley_state",cond=whenDispatch("coapUpdate"))
					transition(edgeName="t017",targetState="state_update_trolley_state",cond=whenDispatch("update_trolley_state"))
				}	 
