...
import robotMbot.SerialPortConnSupport;
...
public class JSSCSerialComm {
    ...
    protected void init(){
        ...
        if (portNames.length == 0) {
            ...
            for (String portName : portNames) {
                System.out.println("JSSCSerialComm: FOUND " + portName + " PORT");
            }
        }
    ...
    public SerialPortConnSupport connect(String commPortName) throws Exception{
        ...
        serialPort = null;
        for (String portName : portNames) {
            if (portName.equals(commPortName)) {
                System.out.println("JSSCSerialComm: CONNECTING TO " + portName);
