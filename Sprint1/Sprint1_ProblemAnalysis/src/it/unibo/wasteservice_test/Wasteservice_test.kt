...
package it.unibo.wasteservice_test
...
class Wasteservice_test ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
				...
				state("state_handle_storerequest") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("storerequest(TYPE,LOAD)"), Term.createTerm("storerequest(TYPE,LOAD)"), 
								...
								request("deposit", "deposit($RequestedWasteType)" ,"transporttrolley_test" )  
								}
								else
								 { WaitingPickup = false  
